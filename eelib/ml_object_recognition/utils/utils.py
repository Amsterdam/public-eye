...
from eelib.ml_object_recognition.utils import torch_utils  # , google_utils
...
def labels_to_class_weights(labels, nc=80):
    ...
    labels = np.concatenate([x for x in labels if len(x.shape) > 1], 0)  # labels.shape = (866643, 5) for COCO
