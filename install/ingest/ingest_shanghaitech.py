...
def main():
    pg.connect()
    root = os.path.join(os.environ['EAGLE_EYE_PATH'], 'files/public_datasets/ShanghaiTech_Crowd_Counting_Dataset')
    part_A_train = os.path.join(root,'part_A_final/train_data','images')
    part_A_test = os.path.join(root,'part_A_final/test_data','images')
    part_B_train = os.path.join(root,'part_B_final/train_data','images')
    part_B_test = os.path.join(root,'part_B_final/test_data','images')

    ingest(part_A_train, 'ShanghaiTech-A-train')
    ingest(part_A_test, 'ShanghaiTech-A-test')
    ingest(part_B_train, 'ShanghaiTech-B-train')
    ingest(part_B_test, 'ShanghaiTech-B-test')
